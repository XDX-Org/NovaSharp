...
| 6. Solution model and Roslyn | Complete | [Qualification run 33404085465](https://github.com/XDX-Org/NovaSharp/actions/runs/33404085465) passed solution loading, warm cached display, fresh-service live validation, replica synchronization, bounded workspace behavior, RID publish, packaged native smoke, performance, disposal, and retained-evidence gates on all six matrix rows from commit `fa06699` |
| 7. C# IntelliSense | Complete | [Qualification run 33404085465](https://github.com/XDX-Org/NovaSharp/actions/runs/33404085465) passed project-aware completion, signature help, hover, formatting, semantic tokens, bounded language work, stale-result rejection, RID publish, packaged native smoke, performance, disposal, and retained-evidence gates on all six matrix rows from commit `fa06699` |
...
responsive behavior are fixed by [ADR 0004](decisions/0004-workbench-shell.md), and editor-group layout ownership and
