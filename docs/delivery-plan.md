...
| 5. Editor groups and split views | In progress | Shared-model split views, bounded layout management, drag/drop, accessible resizing, schema-3 persistence, and local managed/Chromium/WebKit gates are implemented; six-RID qualification evidence is pending |
