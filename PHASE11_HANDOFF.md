...
- Dedicated hideable terminal panel with selection/copy, paste through browser input, search, ANSI colors, safe HTTP(S) links, and screen-reader labels.
...
- 90 unit, integration, and acceptance tests pass locally.
